...
const SelectTrigger = React.forwardRef(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-10 w-full font-semibold space-x-2 items-center justify-between rounded-md border border-sky-700 bg-white px-3 py-2 text-sm ring-offset-white placeholder:text-neutral-500 focus:outline-none focus:ring-2 disabled:cursor-not-allowed disabled:opacity-50",
      className
    )}
    {...props}
  >
    ...
    <SelectPrimitive.Icon asChild>
      <MdOutlineKeyboardArrowDown className="text-xl opacity-70 text-sky-700" />
